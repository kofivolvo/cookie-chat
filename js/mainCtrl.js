angular.module('chatroom').controller('mainCtrl', function($scope, $http, messageService){
...
$scope.postMessage = function (msg) {
  return messageService.postMessage(msg).then(function(response){
    $scope.message = ''//clearMsgBox
  })
